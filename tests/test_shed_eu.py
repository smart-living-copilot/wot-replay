...
class ShedEuFetchTestCase(unittest.TestCase):
    ...
    def test_fetch_with_time_range(self):
        _write_csv(
            self.data_dir / "periodic_data_monthly_csv" / "periodic_data_2023_05.csv",
            [
                "datetime_utc", "id", "country", "room", "sensor",
                "min_value", "average_value", "max_value",
            ],
            [
                ["2023-05-10T10:00:00.000000000", "5", "CH", "bedroom", "temperature", "24", "24", "24"],
                ["2023-05-20T10:00:00.000000000", "5", "CH", "bedroom", "co2", "400", "420", "440"],
            ],
        )
...
class ShedEuBulkImportTestCase(unittest.TestCase):
    ...
    def test_bulk_import_respects_time_range(self):
        _write_csv(
            ...
            [
                ["2023-05-10T10:00:00.000000000", "5", "CH", "bedroom", "temperature", "24", "24", "24"],
                ["2023-05-20T10:00:00.000000000", "5", "CH", "bedroom", "temperature", "25", "25", "25"],
                ["2023-05-25T10:00:00.000000000", "5", "CH", "bedroom", "temperature", "26", "26", "26"],
            ],
        )
